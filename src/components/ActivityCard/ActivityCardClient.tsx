...
interface ActivityCardClientProps {
  activity_id: number;
  name: string;
  priceRange: string;
...
const ActivityCardClient = ({
  activity_id,
  name,
  priceRange,
  bannerImage,
  subCategory,
}: ActivityCardClientProps) => {
  const { location } = useLocation(); // Client-side hook.
...
export default ActivityCardClient;
